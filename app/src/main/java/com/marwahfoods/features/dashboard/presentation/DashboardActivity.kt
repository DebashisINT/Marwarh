package com.marwahfoods.features.dashboard.presentation
...
import com.marwahfoods.CustomStatic
import com.marwahfoods.MySingleton
import com.marwahfoods.R
import com.marwahfoods.app.*
import com.marwahfoods.app.NewFileUtils.browseDocuments
import com.marwahfoods.app.NewFileUtils.getExtension
import com.marwahfoods.app.domain.*
import com.marwahfoods.app.types.DashboardType
import com.marwahfoods.app.types.FragType
import com.marwahfoods.app.types.TopBarConfig
import com.marwahfoods.app.uiaction.DisplayAlert
import com.marwahfoods.app.utils.*
import com.marwahfoods.app.utils.AppUtils.Companion.isProfile
import com.marwahfoods.base.BaseResponse
import com.marwahfoods.base.presentation.BaseActivity
import com.marwahfoods.base.presentation.BaseFragment
import com.marwahfoods.features.NewQuotation.AddQuotFormFragment
import com.marwahfoods.features.NewQuotation.ViewAllQuotListFragment
import com.marwahfoods.features.NewQuotation.ViewDetailsQuotFragment
import com.marwahfoods.features.SearchLocation.SearchLocationFragment
import com.marwahfoods.features.SearchLocation.locationInfoModel
import com.marwahfoods.features.TA.ViewAllTAListFragment
import com.marwahfoods.features.achievement.AchievementFragment
import com.marwahfoods.features.activities.presentation.*
import com.marwahfoods.features.addAttendence.*
import com.marwahfoods.features.addAttendence.model.Leave_list_Response
import com.marwahfoods.features.addorder.presentation.AddOrderFragment
...
import com.marwahfoods.features.addshop.presentation.AddShopFragment
import com.marwahfoods.features.addshop.presentation.OTPVerificationDialog
import com.marwahfoods.features.addshop.presentation.ScanImageFragment
import com.marwahfoods.features.addshop.presentation.ShowCardDetailsDialog
import com.marwahfoods.features.alarm.model.AlarmData
import com.marwahfoods.features.alarm.presetation.AttendanceReportFragment
import com.marwahfoods.features.alarm.presetation.PerformanceReportFragment
import com.marwahfoods.features.alarm.presetation.VisitReportDetailsFragment
import com.marwahfoods.features.alarm.presetation.VisitReportFragment
import com.marwahfoods.features.attendance.AttendanceFragment
import com.marwahfoods.features.attendance.api.AttendanceRepositoryProvider
import com.marwahfoods.features.attendance.model.AttendanceRequest
import com.marwahfoods.features.attendance.model.AttendanceResponse
import com.marwahfoods.features.averageshop.presentation.AverageShopFragment
import com.marwahfoods.features.avgorder.presentation.AverageOrderFragment
import com.marwahfoods.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.marwahfoods.features.billing.presentation.AddBillingFragment
import com.marwahfoods.features.billing.presentation.BillingDetailsFragment
import com.marwahfoods.features.billing.presentation.BillingListFragment
import com.marwahfoods.features.changepassword.presentation.ChangePasswordDialog
import com.marwahfoods.features.chat.model.ChatListDataModel
import com.marwahfoods.features.chat.model.ChatUserDataModel
import com.marwahfoods.features.chat.model.GroupUserDataModel
import com.marwahfoods.features.chat.presentation.*
import com.marwahfoods.features.chatbot.presentation.ChatBotFragment
import com.marwahfoods.features.chatbot.presentation.ChatBotShopListFragment
import com.marwahfoods.features.chatbot.presentation.ReportsFragment
import com.marwahfoods.features.chatbot.presentation.SelectLanguageDialog
import com.marwahfoods.features.commondialog.presentation.CommonDialog
import com.marwahfoods.features.commondialog.presentation.CommonDialogClickListener
import com.marwahfoods.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
import com.marwahfoods.features.commondialogsinglebtn.CommonDialogSingleBtn
import com.marwahfoods.features.commondialogsinglebtn.OnDialogClickListener
import com.marwahfoods.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.marwahfoods.features.dailyPlan.prsentation.AllShopListFragment
import com.marwahfoods.features.dailyPlan.prsentation.DailyPlanListFragment
import com.marwahfoods.features.dailyPlan.prsentation.PlanDetailsFragment
import com.marwahfoods.features.dashboard.presentation.api.ShopVisitImageUploadRepoProvider
import com.marwahfoods.features.dashboard.presentation.api.dashboardApi.DashboardRepoProvider
import com.marwahfoods.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.marwahfoods.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.marwahfoods.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.marwahfoods.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.marwahfoods.features.dashboard.presentation.model.ContentListResponseModel
import com.marwahfoods.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.marwahfoods.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.marwahfoods.features.device_info.presentation.DeviceInfoListFragment
import com.marwahfoods.features.document.DocumentRepoFeatureNewFragment
import com.marwahfoods.features.document.presentation.DocumentListFragment
import com.marwahfoods.features.document.presentation.DocumentTypeListFragment
import com.marwahfoods.features.document.presentation.OpenFileWebViewFragment
import com.marwahfoods.features.dymanicSection.presentation.AddDynamicFragment
import com.marwahfoods.features.dymanicSection.presentation.AllDynamicListFragment
import com.marwahfoods.features.dymanicSection.presentation.DynamicListFragment
import com.marwahfoods.features.dymanicSection.presentation.EditDynamicFragment
import com.marwahfoods.features.gpsDisabilityScreen.GpsDisableFragment
import com.marwahfoods.features.home.presentation.HomeFragment
import com.marwahfoods.features.homelocation.presentation.HomeLocationFragment
import com.marwahfoods.features.homelocation.presentation.HomeLocationMapFragment
import com.marwahfoods.features.know_your_state.KnowYourStateFragment
import com.marwahfoods.features.lead.LeadFrag
import com.marwahfoods.features.lead.ViewLeadFrag
import com.marwahfoods.features.leaveapplynew.LeaveHome
import com.marwahfoods.features.localshops.LocalShopListFragment
import com.marwahfoods.features.localshops.LocalShopListMapFragment
import com.marwahfoods.features.localshops.NearByShopsMapFragment
import com.marwahfoods.features.location.*
import com.marwahfoods.features.login.ShopFeedbackEntity
import com.marwahfoods.features.login.model.alarmconfigmodel.AlarmConfigDataModel
import com.marwahfoods.features.login.presentation.LoginActivity
import com.marwahfoods.features.logout.presentation.api.LogoutRepositoryProvider
import com.marwahfoods.features.logoutsync.presentation.LogoutSyncFragment
import com.marwahfoods.features.marketing.presentation.MarketingPagerFragment
import com.marwahfoods.features.meetinglist.prsentation.MeetingListFragment
import com.marwahfoods.features.member.model.TeamLocDataModel
import com.marwahfoods.features.member.model.TeamShopListDataModel
import com.marwahfoods.features.member.presentation.*
import com.marwahfoods.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.marwahfoods.features.micro_learning.presentation.MicroLearningListFragment
import com.marwahfoods.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.marwahfoods.features.myallowancerequest.MyallowanceRequestFragment
import com.marwahfoods.features.myjobs.model.CustomerDataModel
import com.marwahfoods.features.myjobs.presentation.*
import com.marwahfoods.features.myorder.presentation.MyOrderListFragment
import com.marwahfoods.features.myprofile.presentation.MyProfileFragment
import com.marwahfoods.features.nearbyshops.presentation.BeatListFragment
import com.marwahfoods.features.nearbyshops.presentation.NearByShopsListFragment
import com.marwahfoods.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.marwahfoods.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.marwahfoods.features.newcollection.CollectionDetailsStatusFragment
import com.marwahfoods.features.newcollection.CollectionShopListFragment
import com.marwahfoods.features.newcollection.NewCollectionListFragment
import com.marwahfoods.features.notification.NotificationFragment
import com.marwahfoods.features.orderList.NewDateWiseOrderListFragment
import com.marwahfoods.features.orderList.NewOrderListFragment
import com.marwahfoods.features.orderList.OrderListFragment
import com.marwahfoods.features.orderdetail.presentation.OrderDetailFragment
import com.marwahfoods.features.orderhistory.ActivityMapFragment
import com.marwahfoods.features.orderhistory.OrderhistoryFragment
import com.marwahfoods.features.orderhistory.TimeLineFragment
import com.marwahfoods.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.marwahfoods.features.orderhistory.model.FetchLocationRequest
import com.marwahfoods.features.orderhistory.model.FetchLocationResponse
import com.marwahfoods.features.orderhistory.model.LocationData
import com.marwahfoods.features.performance.GpsStatusFragment
import com.marwahfoods.features.performance.PerformanceFragment
import com.marwahfoods.features.performance.api.UpdateGpsStatusRepoProvider
import com.marwahfoods.features.performance.model.UpdateGpsInputParamsModel
import com.marwahfoods.features.permissionList.ViewPermissionFragment
import com.marwahfoods.features.photoReg.PhotoAttendanceFragment
import com.marwahfoods.features.photoReg.ProtoRegistrationFragment
import com.marwahfoods.features.photoReg.RegisTerFaceFragment
import com.marwahfoods.features.photoReg.TeamAttendanceFragment
import com.marwahfoods.features.quotation.presentation.*
import com.marwahfoods.features.reimbursement.presentation.EditReimbursementFragment
import com.marwahfoods.features.reimbursement.presentation.ReimbursementDetailsFragment
import com.marwahfoods.features.reimbursement.presentation.ReimbursementFragment
import com.marwahfoods.features.reimbursement.presentation.ReimbursementListFragment
import com.marwahfoods.features.report.presentation.*
import com.marwahfoods.features.returnsOrder.*
import com.marwahfoods.features.settings.presentation.SettingsFragment
import com.marwahfoods.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.marwahfoods.features.shopdetail.presentation.*
import com.marwahfoods.features.shopdetail.presentation.api.EditShopRepoProvider
import com.marwahfoods.features.stock.StockDetailsFragment
import com.marwahfoods.features.stock.StockListFragment
import com.marwahfoods.features.stockAddCurrentStock.AddShopStockFragment
import com.marwahfoods.features.stockAddCurrentStock.UpdateShopStockFragment
import com.marwahfoods.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.marwahfoods.features.stockCompetetorStock.AddCompetetorStockFragment
import com.marwahfoods.features.stockCompetetorStock.CompetetorStockFragment
import com.marwahfoods.features.stockCompetetorStock.ViewComStockProductDetails
import com.marwahfoods.features.task.presentation.AddTaskFragment
import com.marwahfoods.features.task.presentation.CalenderTaskFragment
import com.marwahfoods.features.task.presentation.EditTaskFragment
import com.marwahfoods.features.task.presentation.TaskListFragment
import com.marwahfoods.features.timesheet.presentation.AddTimeSheetFragment
import com.marwahfoods.features.timesheet.presentation.EditTimeSheetFragment
import com.marwahfoods.features.timesheet.presentation.TimeSheetListFragment
import com.marwahfoods.features.viewAllOrder.CartFragment
import com.marwahfoods.features.viewAllOrder.OrderTypeListFragment
import com.marwahfoods.features.viewAllOrder.ViewAllOrderListFragment
import com.marwahfoods.features.viewAllOrder.ViewCartFragment
import com.marwahfoods.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.marwahfoods.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.marwahfoods.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.marwahfoods.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.marwahfoods.features.viewPPDDStock.ViewOutstandingFragment
import com.marwahfoods.features.viewPPDDStock.ViewPPDDListFragment
import com.marwahfoods.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.marwahfoods.features.viewPPDDStock.ViewStockFragment
import com.marwahfoods.features.weather.presentation.WeatherFragment
import com.marwahfoods.mappackage.MapActivity
import com.marwahfoods.mappackage.MapActivityWithoutPath
import com.marwahfoods.widgets.AppCustomEditText
import com.marwahfoods.widgets.AppCustomTextView
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xmarwahfoodslogsample/log").path);
            //27-09-2021
            val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmarwahfoodslogsample/log").path);
