package com.marwarhfoods.features.dashboard.presentation
...
import com.marwarhfoods.CustomStatic
import com.marwarhfoods.MySingleton
import com.marwarhfoods.R
import com.marwarhfoods.app.*
import com.marwarhfoods.app.NewFileUtils.browseDocuments
import com.marwarhfoods.app.NewFileUtils.getExtension
import com.marwarhfoods.app.domain.*
import com.marwarhfoods.app.types.DashboardType
import com.marwarhfoods.app.types.FragType
import com.marwarhfoods.app.types.TopBarConfig
import com.marwarhfoods.app.uiaction.DisplayAlert
import com.marwarhfoods.app.utils.*
import com.marwarhfoods.app.utils.AppUtils.Companion.isProfile
...
import com.marwarhfoods.features.NewQuotation.AddQuotFormFragment
import com.marwarhfoods.features.NewQuotation.ViewAllQuotListFragment
import com.marwarhfoods.features.NewQuotation.ViewDetailsQuotFragment
import com.marwarhfoods.features.SearchLocation.SearchLocationFragment
import com.marwarhfoods.features.SearchLocation.locationInfoModel
import com.marwarhfoods.features.TA.ViewAllTAListFragment
import com.marwarhfoods.features.achievement.AchievementFragment
import com.marwarhfoods.features.activities.presentation.*
import com.marwarhfoods.features.addAttendence.*
import com.marwarhfoods.features.addAttendence.model.Leave_list_Response
import com.marwarhfoods.features.addorder.presentation.AddOrderFragment
...
import com.marwarhfoods.features.addshop.presentation.AddShopFragment
import com.marwarhfoods.features.addshop.presentation.OTPVerificationDialog
import com.marwarhfoods.features.addshop.presentation.ScanImageFragment
import com.marwarhfoods.features.addshop.presentation.ShowCardDetailsDialog
import com.marwarhfoods.features.alarm.model.AlarmData
import com.marwarhfoods.features.alarm.presetation.AttendanceReportFragment
import com.marwarhfoods.features.alarm.presetation.PerformanceReportFragment
import com.marwarhfoods.features.alarm.presetation.VisitReportDetailsFragment
import com.marwarhfoods.features.alarm.presetation.VisitReportFragment
import com.marwarhfoods.features.attendance.AttendanceFragment
import com.marwarhfoods.features.attendance.api.AttendanceRepositoryProvider
...
import com.marwarhfoods.features.averageshop.presentation.AverageShopFragment
import com.marwarhfoods.features.avgorder.presentation.AverageOrderFragment
import com.marwarhfoods.features.avgtimespent.presentation.AvgTimespentShopListFragment
import com.marwarhfoods.features.billing.presentation.AddBillingFragment
import com.marwarhfoods.features.billing.presentation.BillingDetailsFragment
import com.marwarhfoods.features.billing.presentation.BillingListFragment
import com.marwarhfoods.features.changepassword.presentation.ChangePasswordDialog
import com.marwarhfoods.features.chat.model.ChatListDataModel
import com.marwarhfoods.features.chat.model.ChatUserDataModel
import com.marwarhfoods.features.chat.model.GroupUserDataModel
import com.marwarhfoods.features.chat.presentation.*
import com.marwarhfoods.features.chatbot.presentation.ChatBotFragment
import com.marwarhfoods.features.chatbot.presentation.ChatBotShopListFragment
import com.marwarhfoods.features.chatbot.presentation.ReportsFragment
import com.marwarhfoods.features.chatbot.presentation.SelectLanguageDialog
...
import com.marwarhfoods.features.commondialogsinglebtn.AddFeedbackSingleBtnDialog
...
import com.marwarhfoods.features.commondialogsinglebtn.TermsAndConditionsSingleBtnDialog
import com.marwarhfoods.features.dailyPlan.prsentation.AllShopListFragment
import com.marwarhfoods.features.dailyPlan.prsentation.DailyPlanListFragment
import com.marwarhfoods.features.dailyPlan.prsentation.PlanDetailsFragment
...
import com.marwarhfoods.features.dashboard.presentation.api.otpsentapi.OtpSentRepoProvider
import com.marwarhfoods.features.dashboard.presentation.api.otpverifyapi.OtpVerificationRepoProvider
import com.marwarhfoods.features.dashboard.presentation.api.unreadnotificationapi.UnreadNotificationRepoProvider
import com.marwarhfoods.features.dashboard.presentation.getcontentlisapi.GetContentListRepoProvider
import com.marwarhfoods.features.dashboard.presentation.model.ContentListResponseModel
import com.marwarhfoods.features.dashboard.presentation.model.ShopVisitImageUploadInputModel
import com.marwarhfoods.features.dashboard.presentation.model.UnreadNotificationResponseModel
import com.marwarhfoods.features.device_info.presentation.DeviceInfoListFragment
import com.marwarhfoods.features.document.DocumentRepoFeatureNewFragment
import com.marwarhfoods.features.document.presentation.DocumentListFragment
import com.marwarhfoods.features.document.presentation.DocumentTypeListFragment
import com.marwarhfoods.features.document.presentation.OpenFileWebViewFragment
import com.marwarhfoods.features.dymanicSection.presentation.AddDynamicFragment
import com.marwarhfoods.features.dymanicSection.presentation.AllDynamicListFragment
import com.marwarhfoods.features.dymanicSection.presentation.DynamicListFragment
import com.marwarhfoods.features.dymanicSection.presentation.EditDynamicFragment
import com.marwarhfoods.features.gpsDisabilityScreen.GpsDisableFragment
import com.marwarhfoods.features.home.presentation.HomeFragment
import com.marwarhfoods.features.homelocation.presentation.HomeLocationFragment
import com.marwarhfoods.features.homelocation.presentation.HomeLocationMapFragment
import com.marwarhfoods.features.know_your_state.KnowYourStateFragment
import com.marwarhfoods.features.lead.LeadFrag
import com.marwarhfoods.features.lead.ViewLeadFrag
import com.marwarhfoods.features.leaveapplynew.LeaveHome
import com.marwarhfoods.features.localshops.LocalShopListFragment
import com.marwarhfoods.features.localshops.LocalShopListMapFragment
import com.marwarhfoods.features.localshops.NearByShopsMapFragment
import com.marwarhfoods.features.location.*
import com.marwarhfoods.features.login.ShopFeedbackEntity
import com.marwarhfoods.features.login.model.alarmconfigmodel.AlarmConfigDataModel
...
import com.marwarhfoods.features.logoutsync.presentation.LogoutSyncFragment
import com.marwarhfoods.features.marketing.presentation.MarketingPagerFragment
import com.marwarhfoods.features.meetinglist.prsentation.MeetingListFragment
import com.marwarhfoods.features.member.model.TeamLocDataModel
import com.marwarhfoods.features.member.model.TeamShopListDataModel
import com.marwarhfoods.features.member.presentation.*
import com.marwarhfoods.features.micro_learning.presentation.FileOpeningTimeIntentService
import com.marwarhfoods.features.micro_learning.presentation.MicroLearningListFragment
import com.marwarhfoods.features.micro_learning.presentation.MicroLearningWebViewFragment
import com.marwarhfoods.features.myallowancerequest.MyallowanceRequestFragment
import com.marwarhfoods.features.myjobs.model.CustomerDataModel
import com.marwarhfoods.features.myjobs.presentation.*
import com.marwarhfoods.features.myorder.presentation.MyOrderListFragment
import com.marwarhfoods.features.myprofile.presentation.MyProfileFragment
import com.marwarhfoods.features.nearbyshops.presentation.BeatListFragment
import com.marwarhfoods.features.nearbyshops.presentation.NearByShopsListFragment
import com.marwarhfoods.features.nearbyshops.presentation.NewNearByShopsListFragment
import com.marwarhfoods.features.nearbyuserlist.presentation.NearbyUserListFragment
import com.marwarhfoods.features.newcollection.CollectionDetailsStatusFragment
import com.marwarhfoods.features.newcollection.CollectionShopListFragment
import com.marwarhfoods.features.newcollection.NewCollectionListFragment
import com.marwarhfoods.features.notification.NotificationFragment
import com.marwarhfoods.features.orderList.NewDateWiseOrderListFragment
import com.marwarhfoods.features.orderList.NewOrderListFragment
import com.marwarhfoods.features.orderList.OrderListFragment
import com.marwarhfoods.features.orderdetail.presentation.OrderDetailFragment
import com.marwarhfoods.features.orderhistory.ActivityMapFragment
import com.marwarhfoods.features.orderhistory.OrderhistoryFragment
import com.marwarhfoods.features.orderhistory.TimeLineFragment
import com.marwarhfoods.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.marwarhfoods.features.orderhistory.model.FetchLocationRequest
import com.marwarhfoods.features.orderhistory.model.FetchLocationResponse
import com.marwarhfoods.features.orderhistory.model.LocationData
import com.marwarhfoods.features.performance.GpsStatusFragment
import com.marwarhfoods.features.performance.PerformanceFragment
...
import com.marwarhfoods.features.permissionList.ViewPermissionFragment
import com.marwarhfoods.features.photoReg.PhotoAttendanceFragment
import com.marwarhfoods.features.photoReg.ProtoRegistrationFragment
import com.marwarhfoods.features.photoReg.RegisTerFaceFragment
import com.marwarhfoods.features.photoReg.TeamAttendanceFragment
import com.marwarhfoods.features.quotation.presentation.*
import com.marwarhfoods.features.reimbursement.presentation.EditReimbursementFragment
import com.marwarhfoods.features.reimbursement.presentation.ReimbursementDetailsFragment
import com.marwarhfoods.features.reimbursement.presentation.ReimbursementFragment
import com.marwarhfoods.features.reimbursement.presentation.ReimbursementListFragment
import com.marwarhfoods.features.report.presentation.*
import com.marwarhfoods.features.returnsOrder.*
import com.marwarhfoods.features.settings.presentation.SettingsFragment
import com.marwarhfoods.features.shopFeedbackHistory.ShopFeedbackHisFrag
import com.marwarhfoods.features.shopdetail.presentation.*
import com.marwarhfoods.features.shopdetail.presentation.api.EditShopRepoProvider
import com.marwarhfoods.features.stock.StockDetailsFragment
import com.marwarhfoods.features.stock.StockListFragment
import com.marwarhfoods.features.stockAddCurrentStock.AddShopStockFragment
import com.marwarhfoods.features.stockAddCurrentStock.UpdateShopStockFragment
import com.marwarhfoods.features.stockAddCurrentStock.ViewStockDetailsFragment
import com.marwarhfoods.features.stockCompetetorStock.AddCompetetorStockFragment
import com.marwarhfoods.features.stockCompetetorStock.CompetetorStockFragment
import com.marwarhfoods.features.stockCompetetorStock.ViewComStockProductDetails
import com.marwarhfoods.features.task.presentation.AddTaskFragment
import com.marwarhfoods.features.task.presentation.CalenderTaskFragment
import com.marwarhfoods.features.task.presentation.EditTaskFragment
import com.marwarhfoods.features.task.presentation.TaskListFragment
import com.marwarhfoods.features.timesheet.presentation.AddTimeSheetFragment
import com.marwarhfoods.features.timesheet.presentation.EditTimeSheetFragment
import com.marwarhfoods.features.timesheet.presentation.TimeSheetListFragment
import com.marwarhfoods.features.viewAllOrder.CartFragment
import com.marwarhfoods.features.viewAllOrder.OrderTypeListFragment
import com.marwarhfoods.features.viewAllOrder.ViewAllOrderListFragment
import com.marwarhfoods.features.viewAllOrder.ViewCartFragment
import com.marwarhfoods.features.viewAllOrder.orderNew.NewOdrScrListFragment
import com.marwarhfoods.features.viewAllOrder.orderNew.NewOrderScrActiFragment
import com.marwarhfoods.features.viewAllOrder.orderNew.NewOrderScrOrderDetailsFragment
import com.marwarhfoods.features.viewAllOrder.orderNew.NeworderScrCartFragment
import com.marwarhfoods.features.viewPPDDStock.ViewOutstandingFragment
import com.marwarhfoods.features.viewPPDDStock.ViewPPDDListFragment
import com.marwarhfoods.features.viewPPDDStock.ViewPPDDListOutstandingFragment
import com.marwarhfoods.features.viewPPDDStock.ViewStockFragment
import com.marwarhfoods.features.weather.presentation.WeatherFragment
import com.marwarhfoods.mappackage.MapActivity
import com.marwarhfoods.mappackage.MapActivityWithoutPath
import com.marwarhfoods.widgets.AppCustomEditText
...
//        val phototUri = Uri.parse(localAbsoluteFilePath)
            //val fileUrl = Uri.parse(File(Environment.getExternalStorageDirectory(), "xmarwarhfoodslogsample/log").path);
            //27-09-2021
...
//        startActivity(Intent.createChooser(emailIntent,""))
    ...
    fun openShare(){
        try{
            ...
            val fileUrl1 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmarwarhfoodslogsample/log").path);
            val fileUrl2 = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xmarwarhfoodslogsample/log.bak.1").path);
    ...
    fun generateNoteOnSD(context: Context?, sFileName: String?, sBody: String?) {
        try {
            val root =  File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS),
                    "xmarwarhfoodslogsample/log" + ".txt")
            if (!root.exists()) {
                root.mkdirs()
            }
